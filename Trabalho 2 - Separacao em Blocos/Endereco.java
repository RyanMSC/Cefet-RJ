...
public class Endereco {
	...
	public static Comparator<Endereco> COMPARE_BY_CEP = new Comparator<Endereco>() {
	        public int compare(Endereco one, Endereco other) {
	            return one.cep.compareTo(other.cep);
	        }
	   };
